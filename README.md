# @erboladaiorg/dolorem-numquam [![NPM version](https://img.shields.io/npm/v/@erboladaiorg/dolorem-numquam.svg?style=flat)](https://www.npmjs.com/package/@erboladaiorg/dolorem-numquam) [![NPM monthly downloads](https://img.shields.io/npm/dm/@erboladaiorg/dolorem-numquam.svg?style=flat)](https://npmjs.org/package/@erboladaiorg/dolorem-numquam) [![NPM total downloads](https://img.shields.io/npm/dt/@erboladaiorg/dolorem-numquam.svg?style=flat)](https://npmjs.org/package/@erboladaiorg/dolorem-numquam)  [![Tests](https://github.com/erboladaiorg/dolorem-numquam/actions/workflows/test.yml/badge.svg)](https://github.com/erboladaiorg/dolorem-numquam/actions/workflows/test.yml)
...
- [Sponsors](#sponsors)
  ...
  * [Why use @erboladaiorg/dolorem-numquam?](#why-use-@erboladaiorg/dolorem-numquam)
    + [Matching features](#matching-features)
  * [Switching to @erboladaiorg/dolorem-numquam](#switching-to-@erboladaiorg/dolorem-numquam)
...
```sh
$ npm install --save @erboladaiorg/dolorem-numquam
```
...
```js
const @erboladaiorg/dolorem-numquam = require('@erboladaiorg/dolorem-numquam');
// @erboladaiorg/dolorem-numquam(list, patterns[, options]);
```

The [main export](#@erboladaiorg/dolorem-numquam) takes a list of strings and one or more glob patterns:

```js
console.log(@erboladaiorg/dolorem-numquam(['foo', 'bar', 'baz', 'qux'], ['f*', 'b*'])) //=> ['foo', 'bar', 'baz']
console.log(@erboladaiorg/dolorem-numquam(['foo', 'bar', 'baz', 'qux'], ['*', '!b*'])) //=> ['foo', 'qux']
```

Use [.isMatch()](#ismatch) to for boolean matching:

```js
console.log(@erboladaiorg/dolorem-numquam.isMatch('foo', 'f*')) //=> true
console.log(@erboladaiorg/dolorem-numquam.isMatch('foo', ['b*', 'f*'])) //=> true
```

[Switching](#switching-to-@erboladaiorg/dolorem-numquam) from minimatch and multimatch is easy!

<br>

## Why use @erboladaiorg/dolorem-numquam?

> @erboladaiorg/dolorem-numquam is a [replacement](#switching-to-@erboladaiorg/dolorem-numquam) for minimatch and multimatch
...
## Switching to @erboladaiorg/dolorem-numquam

_(There is one notable difference between @erboladaiorg/dolorem-numquam and minimatch in regards to how backslashes are handled. See [the notes about backslashes](#backslashes) for more information.)_

### From minimatch

Use [@erboladaiorg/dolorem-numquam.isMatch()](#ismatch) instead of `minimatch()`:

```js
console.log(@erboladaiorg/dolorem-numquam.isMatch('foo', 'b*')); //=> false
```

Use [@erboladaiorg/dolorem-numquam.match()](#match) instead of `minimatch.match()`:

```js
console.log(@erboladaiorg/dolorem-numquam.match(['foo', 'bar'], 'b*')); //=> 'bar'
```
...
```js
console.log(@erboladaiorg/dolorem-numquam(['foo', 'bar', 'baz'], ['f*', '*z'])); //=> ['foo', 'baz']
```
...
```js
const mm = require('@erboladaiorg/dolorem-numquam');
...
```js
var mm = require('@erboladaiorg/dolorem-numquam');
...
```js
const { braces } = require('@erboladaiorg/dolorem-numquam');
...
```js
@erboladaiorg/dolorem-numquam(['a/b.js', 'a/c.md'], '*.js');
//=> []

@erboladaiorg/dolorem-numquam(['a/b.js', 'a/c.md'], '*.js', { basename: true });
//=> ['a/b.js']
```
...
```js
const files = ['abc', 'ajz'];
console.log(@erboladaiorg/dolorem-numquam(files, '[a-c]*'));
//=> ['abc', 'ajz']

console.log(@erboladaiorg/dolorem-numquam(files, '[a-c]*', { bash: false }));
```
...
const regex = @erboladaiorg/dolorem-numquam.makeRe('foo/{01..25}/bar', {
  expandRange(a, b) {
...
```js
const isMatch = @erboladaiorg/dolorem-numquam.matcher('*', { ignore: 'f*' });
...
```js
console.log(@erboladaiorg/dolorem-numquam(['a/z', 'a/b', 'a/!(z)'], 'a/!(z)'));
//=> ['a/b', 'a/!(z)']

console.log(@erboladaiorg/dolorem-numquam(['a/z', 'a/b', 'a/!(z)'], 'a/!(z)', { noextglob: true }));
...
```js
@erboladaiorg/dolorem-numquam(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**');
//=> ['a/b', 'a/b/c', 'a/b/c/d']

@erboladaiorg/dolorem-numquam(['a/b', 'a/b/c', 'a/b/c/d'], 'a/**', {noglobstar: true});
//=> ['a/b']
```
...
const isMatch = @erboladaiorg/dolorem-numquam.matcher('*', { onIgnore, ignore: 'f*' });
isMatch('foo');
isMatch('bar');
isMatch('baz');
```
...
const isMatch = @erboladaiorg/dolorem-numquam.matcher('**', { onMatch, posixSlashes: true });
isMatch('some\\path');
isMatch('some\\path');
isMatch('some\\path');
```
...
const isMatch = @erboladaiorg/dolorem-numquam('*', { onResult, ignore: 'f*' });
isMatch('foo');
isMatch('bar');
isMatch('baz');
```
...
```js
console.log(@erboladaiorg/dolorem-numquam.match(['a\\b\\c'], 'a/**'));
//=> ['a/b/c']

console.log(@erboladaiorg/dolorem-numquam.match(['a\\b\\c'], { posixSlashes: false }));
//=> ['a\\b\\c']
```
...
```js
console.log(@erboladaiorg/dolorem-numquam.match(['abc', 'a\\*c'], 'a\\*c'));
//=> ['a\\*c']

console.log(@erboladaiorg/dolorem-numquam.match(['abc', 'a\\*c'], 'a\\*c', { unescape: true }));
//=> ['a*c']
```
...
```js
console.log(@erboladaiorg/dolorem-numquam.isMatch('a1', '[[:alpha:][:digit:]]')) //=> true
console.log(@erboladaiorg/dolorem-numquam.isMatch('a1', '[[:alpha:][:alpha:]]')) //=> false
```
...
However, it's suprising how many edge cases and rabbit holes there are with glob matching, and since there is no real glob specification, and @erboladaiorg/dolorem-numquam is more accurate than both Bash and minimatch, there are cases where best-guesses were made for behavior. In a few cases where Bash had no answers, we used wildmatch (used by git) as a fallback.

### Backslashes

There is an important, notable difference between minimatch and @erboladaiorg/dolorem-numquam _in regards to how backslashes are handled_ in glob patterns.
...
We made this decision for @erboladaiorg/dolorem-numquam for a couple of reasons:
...
Note that when you pass something like `path.join('foo', '*')` to @erboladaiorg/dolorem-numquam, you are creating a filepath and expecting it to still work as a glob pattern. This causes problems on windows, since the `path.sep` is `\\`.

In other words, since `\\` is reserved as an escape character in globs, on windows `path.join('foo', '*')` would result in `foo\\*`, which tells @erboladaiorg/dolorem-numquam to match `*` as a literal character. This is the same behavior as bash.
...
```sh
# .makeRe star
  @erboladaiorg/dolorem-numquam x 2,232,802 ops/sec ±2.34% (89 runs sampled))
  minimatch x 781,018 ops/sec ±6.74% (92 runs sampled))

# .makeRe star; dot=true
  @erboladaiorg/dolorem-numquam x 1,863,453 ops/sec ±0.74% (93 runs sampled)
  minimatch x 723,105 ops/sec ±0.75% (93 runs sampled)

# .makeRe globstar
  @erboladaiorg/dolorem-numquam x 1,624,179 ops/sec ±2.22% (91 runs sampled)
  minimatch x 1,117,230 ops/sec ±2.78% (86 runs sampled))

# .makeRe globstars
  @erboladaiorg/dolorem-numquam x 1,658,642 ops/sec ±0.86% (92 runs sampled)
  minimatch x 741,224 ops/sec ±1.24% (89 runs sampled))

# .makeRe with leading star
  @erboladaiorg/dolorem-numquam x 1,525,014 ops/sec ±1.63% (90 runs sampled)
  minimatch x 561,074 ops/sec ±3.07% (89 runs sampled)

# .makeRe - braces
  @erboladaiorg/dolorem-numquam x 172,478 ops/sec ±2.37% (78 runs sampled)
  minimatch x 96,087 ops/sec ±2.34% (88 runs sampled)))

# .makeRe braces - range (expanded)
  @erboladaiorg/dolorem-numquam x 26,973 ops/sec ±0.84% (89 runs sampled)
  minimatch x 3,023 ops/sec ±0.99% (90 runs sampled))

# .makeRe braces - range (compiled)
  @erboladaiorg/dolorem-numquam x 152,892 ops/sec ±1.67% (83 runs sampled)
  minimatch x 992 ops/sec ±3.50% (89 runs sampled)d))

# .makeRe braces - nested ranges (expanded)
  @erboladaiorg/dolorem-numquam x 15,816 ops/sec ±13.05% (80 runs sampled)
  minimatch x 2,953 ops/sec ±1.64% (91 runs sampled)

# .makeRe braces - nested ranges (compiled)
  @erboladaiorg/dolorem-numquam x 110,881 ops/sec ±1.85% (82 runs sampled)
  minimatch x 1,008 ops/sec ±1.51% (91 runs sampled)

# .makeRe braces - set (compiled)
  @erboladaiorg/dolorem-numquam x 134,930 ops/sec ±3.54% (63 runs sampled))
  minimatch x 43,242 ops/sec ±0.60% (93 runs sampled)

# .makeRe braces - nested sets (compiled)
  @erboladaiorg/dolorem-numquam x 94,455 ops/sec ±1.74% (69 runs sampled))
...
It's important to us that @erboladaiorg/dolorem-numquam work consistently on all platforms. If you encounter any platform-specific matching or path related issues, please let us know (pull requests are also greatly appreciated).
...
[brackets]: https://github.com/@erboladaiorg/dolorem-numquam/expand-brackets
[braces]: https://github.com/@erboladaiorg/dolorem-numquam/braces
...
- [braces](https://www.npmjs.com/package/braces): Bash-like brace expansion, implemented in JavaScript. Safer than other brace expansion libs, with complete support… [more](https://github.com/@erboladaiorg/dolorem-numquam/braces) | [homepage](https://github.com/@erboladaiorg/dolorem-numquam/braces "Bash-like brace expansion, implemented in JavaScript. Safer than other brace expansion libs, with complete support for the Bash 4.3 braces specification, without sacrificing speed.")
- [expand-brackets](https://www.npmjs.com/package/expand-brackets): Expand POSIX bracket expressions (character classes) in glob patterns. | [homepage](https://github.com/@erboladaiorg/dolorem-numquam/expand-brackets "Expand POSIX bracket expressions (character classes) in glob patterns.")
- [extglob](https://www.npmjs.com/package/extglob): Extended glob support for JavaScript. Adds (almost) the expressive power of regular expressions to glob… [more](https://github.com/@erboladaiorg/dolorem-numquam/extglob) | [homepage](https://github.com/@erboladaiorg/dolorem-numquam/extglob "Extended glob support for JavaScript. Adds (almost) the expressive power of regular expressions to glob patterns.")
- [fill-range](https://www.npmjs.com/package/fill-range): Fill in a range of numbers or letters, optionally passing an increment or `step` to… [more](https://github.com/jonschlinkert/fill-range) | [homepage](https://github.com/jonschlinkert/fill-range "Fill in a range of numbers or letters, optionally passing an increment or `step` to use, or create a regex-compatible range with `options.toRegex`")
- [nanomatch](https://www.npmjs.com/package/nanomatch): Fast, minimal glob matcher for node.js. Similar to @erboladaiorg/dolorem-numquam, minimatch and multimatch, but complete Bash… [more](https://github.com/@erboladaiorg/dolorem-numquam/nanomatch) | [homepage](https://github.com/@erboladaiorg/dolorem-numquam/nanomatch "Fast, minimal glob matcher for node.js. Similar to @erboladaiorg/dolorem-numquam, minimatch and multimatch, but complete Bash 4.3 wildcard support only (no support for exglobs, posix brackets or braces)")
...
[extglob]: https://github.com/@erboladaiorg/dolorem-numquam/extglob
